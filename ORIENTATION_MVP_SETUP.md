...
CREATE TABLE careers (
  ...
  -- Contexte socio-économique & compatibilité
  financial_requirement VARCHAR(10) DEFAULT 'medium', -- 'low'|'medium'|'high'
  requires_network BOOLEAN DEFAULT false,
  preferred_location VARCHAR(20) DEFAULT 'urban', -- 'urban'|'semi-urban'|'rural'
  religious_friendly VARCHAR(20) DEFAULT 'neutral', -- 'friendly'|'neutral'|'challenging'
