          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
            ...
            <TabsContent value="conversation" className="space-y-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <Card className="border-l-4 border-l-blue-500 shadow-[0_0_16px_0_rgba(34,197,94,0.10)] dark:shadow-[0_0_24px_0_rgba(34,197,94,0.18)] dark:bg-slate-800 dark:border-blue-700">
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-xs text-slate-600 dark:text-slate-300">Chapitres</p>
                        <p className="text-2xl font-bold text-slate-900 dark:text-white">{userStats.completedChapters}</p>
                      </div>
                ...
                <Card className="border-l-4 border-l-green-500 shadow-[0_0_16px_0_rgba(34,197,94,0.10)] dark:shadow-[0_0_24px_0_rgba(34,197,94,0.18)] dark:bg-slate-800 dark:border-green-700">
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-xs text-slate-600 dark:text-slate-300">Badges</p>
                        <p className="text-2xl font-bold text-slate-900 dark:text-white">{userStats.totalBadges}</p>
                      </div>
                ...
                <Card className="border-l-4 border-l-purple-500 shadow-[0_0_16px_0_rgba(34,197,94,0.10)] dark:shadow-[0_0_24px_0_rgba(34,197,94,0.18)] dark:bg-slate-800 dark:border-purple-700">
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-xs text-slate-600 dark:text-slate-300">Score moy.</p>
                        <p className="text-2xl font-bold text-slate-900 dark:text-white">{userStats.averageScore}%</p>
                      </div>
                ...
                <Card className="border-l-4 border-l-orange-500 shadow-[0_0_16px_0_rgba(34,197,94,0.10)] dark:shadow-[0_0_24px_0_rgba(34,197,94,0.18)] dark:bg-slate-800 dark:border-orange-700">
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-xs text-slate-600 dark:text-slate-300">Niveau</p>
                        <p className="text-2xl font-bold text-slate-900 dark:text-white">{userStats.level}</p>
                      </div>
            ...
            <TabsContent value="analyse" className="space-y-6">
              {loadingAnalysis ? (
                ...
                <>
                  {/* Hero card avec message motivant */}
                  <Card className="bg-gradient-to-r from-primary to-indigo-600 text-white overflow-hidden">
                    <CardContent className="p-8">
                      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-3">
                            <Brain className="w-8 h-8" />
                            <h2 className="text-3xl font-bold">Analyse Personnalisée</h2>
                          </div>
                          <p className="text-lg text-blue-100 mb-6">{motivationalMessage}</p>
                          
                          {/* Note globale & stats */}
                          <div className="flex flex-wrap gap-6">
                            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                              <p className="text-sm text-blue-100 mb-1">Note Globale</p>
                              <div className={`text-5xl font-bold px-3 py-1 rounded ${getGradeColor(analysis.overall.grade)}`}>
                                {analysis.overall.grade}
                              </div>
                            </div>
                            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                              <p className="text-sm text-blue-100 mb-1">Niveau</p>
                              <p className="text-4xl font-bold">{analysis.overall.level}</p>
                            </div>
                            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                              <p className="text-sm text-blue-100 mb-1">Streak</p>
                              <p className="text-4xl font-bold">🔥 {analysis.studyHabits.currentStreak}</p>
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <Card className="border-l-4 border-l-blue-500">
                      <CardContent className="p-6">
                        <div className="flex items-center justify-between mb-2">
                          <BookOpen className="w-8 h-8 text-blue-500" />
                          <span className="text-3xl font-bold text-slate-900 dark:text-white">{analysis.overall.completionRate}%</span>
                        </div>
                        <p className="text-sm font-medium text-slate-600 dark:text-slate-300">Taux de complétion</p>
                        <p className="text-xs text-slate-500 mt-1">Chapitres terminés</p>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="border-l-4 border-l-green-500">
                      <CardContent className="p-6">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span className="text-3xl font-bold text-slate-900 dark:text-white">{analysis.overall.totalPoints}</span>
                        </div>
                        <p className="text-sm font-medium text-slate-600 dark:text-slate-300">Points totaux</p>
                        <p className="text-xs text-slate-500 mt-1">Score cumulé</p>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="border-l-4 border-l-purple-500">
                      <CardContent className="p-6">
                        <div className="flex items-center justify-between mb-2">
                          <Target className="w-8 h-8 text-purple-500" />
                          <span className="text-3xl font-bold text-slate-900 dark:text-white">{analysis.overall.averageScore}%</span>
                        </div>
                        <p className="text-sm font-medium text-slate-600 dark:text-slate-300">Score moyen</p>
                        <p className="text-xs text-slate-500 mt-1">Tous les quiz</p>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="border-l-4 border-l-orange-500">
                      <CardContent className="p-6">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span className="text-3xl font-bold text-slate-900 dark:text-white">{analysis.studyHabits.consistency}%</span>
                        </div>
                        <p className="text-sm font-medium text-slate-600 dark:text-slate-300">Régularité</p>
                        <p className="text-xs text-slate-500 mt-1">Habitudes d'étude</p>
                      </CardContent>
                    </Card>
                  </div>
