          ...
          <Card className="mt-8 dark:bg-slate-800 dark:border-white/20 border-2 shadow-lg dark:shadow-[0_0_30px_rgba(255,255,255,0.4)]">
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-8 gap-4">
                ...
                <Link to="/challenges">
                  <Button variant="outline" className="w-full h-20 flex-col gap-2 border-yellow-300 hover:border-yellow-500 hover:bg-yellow-50">
                    <Zap className="w-6 h-6 text-yellow-600" />
                    <span className="text-yellow-600 font-semibold text-sm">Défis</span>
                  </Button>
                </Link>
                <Link to="/social">
